...
-(NSString *) getIOSUUID
{
    NSString *retrieveuuid = [SSKeychain passwordForService:@"com.sjhz.mobile.app" account:@"uuid"];
    if ( retrieveuuid == nil || [retrieveuuid isEqualToString:@""])
    {
        ...
        CFRelease(uuidStr);
        [SSKeychain setPassword: retrieveuuid forService:@"com.sjhz.mobile.app"account:@"uuid"];
    }
